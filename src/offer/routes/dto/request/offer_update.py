...
from src.offer.enums.offer_type import OfferType
from src.offer.enums.offer_use_type import OfferUseType
from src.offer.routes.dto.request.offer_target_detail import OfferTargetDetail
