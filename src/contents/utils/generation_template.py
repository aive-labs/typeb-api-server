...
template_dict = {
    "t00001": """
        ...
        제목 뒤에는 __divider__, __summary__[non_edit_sum], __youtube__[youtube_uri], __dashed_divider__를 각각 한 줄씩 추가하세요. '[]' 안에 있는 내용은 **절대** 변경하지말고 그대로 출력하세요. 고정값입니다.
        ...
        정보가 주제와 관련없는 경우에는 활용하지 않아도 됩니다.
    ...
    "t00002": """
        ...
        아래의 형식에 맞춰 출력하세요. 단, '[]' 안에 있는 내용은 **절대** 변경하지말고 그대로 출력하세요. 고정값입니다.
        __title__제목은 여기에 작성하세요.
        제목 뒤에는 __divider__, __summary__[non_edit_sum], __image__[img_uri], __dashed_divider__를 각각 한 줄씩 추가하세요. '[]' 안에 있는 내용은 **절대** 변경하지말고 그대로 출력하세요. 고정값입니다.
    ...
    "t00005": """
        ...
        각 문단이 시작할때 항상 __text__를 앞에 포함해서 작성해주세요.
        제목 뒤에는 __divider__를 한 줄 추가하세요.
        서론 뒤, 결론 앞에 각각 __image__[img_uri] 를 한 줄씩 추가하세요. '[]' 안에 있는 내용은 **절대** 변경하지말고 그대로 출력하세요. 고정값입니다.
        형식 사이 사이에 줄바꿈을 공백으로 남기지 마세요.
        정보가 주제와 관련없는 경우에는 활용하지 않아도 됩니다.
    ...
    "t00008": """
        ...
        제목 뒤에는 __divider__를 한 줄 추가하고, 모든 문장 혹은 어구의 앞에 __image__[img_uri]를 한 줄씩 추가하세요. '[]' 안에 있는 내용은 **절대** 변경하지말고 그대로 출력하세요. 고정값입니다.
        정보가 주제와 관련없는 경우에는 활용하지 않아도 됩니다.
